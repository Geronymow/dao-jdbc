...
public class SellerDaoJDBC extends Factory implements SellerDao {
    ...
    public Seller findById(Integer id) {
        ...
        try {
            ...
            if(rs.next()) {
                ...
                //Após executar a solicitação para o Banco de dados, criamos
                //dois objetos (Seller e Department)
